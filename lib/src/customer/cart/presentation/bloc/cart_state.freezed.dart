...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<CartItemEntity> items,  Set<int> selectedIds)?  loaded,TResult Function( String message)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case CartInitial() when initial != null:
return initial();case CartLoading() when loading != null:
return loading();case CartLoaded() when loaded != null:
return loaded(_that.items,_that.selectedIds);case CartError() when error != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<CartItemEntity> items,  Set<int> selectedIds)  loaded,required TResult Function( String message)  error,}) {final _that = this;
switch (_that) {
case CartInitial():
return initial();case CartLoading():
return loading();case CartLoaded():
return loaded(_that.items,_that.selectedIds);case CartError():
return error(_that.message);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<CartItemEntity> items,  Set<int> selectedIds)?  loaded,TResult? Function( String message)?  error,}) {final _that = this;
switch (_that) {
case CartInitial() when initial != null:
return initial();case CartLoading() when loading != null:
return loading();case CartLoaded() when loaded != null:
...
class CartLoaded implements CartState {
  const CartLoaded(final  List<CartItemEntity> items, {final  Set<int> selectedIds = const <int>{}}): _items = items,_selectedIds = selectedIds;
...
@JsonKey() Set<int> get selectedIds {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is CartLoaded&&const DeepCollectionEquality().equals(other._items, _items)&&const DeepCollectionEquality().equals(other._selectedIds, _selectedIds));
}


@override
int get hashCode => Object.hash(runtimeType,const DeepCollectionEquality().hash(_items),const DeepCollectionEquality().hash(_selectedIds));

@override
String toString() {
  return 'CartState.loaded(items: $items, selectedIds: $selectedIds)';
}
...
@useResult
$Res call({
 List<CartItemEntity> items, Set<int> selectedIds
});
...
/// Create a copy of CartState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? items = null,Object? selectedIds = null,}) {
  return _then(CartLoaded(
null == items ? _self._items : items // ignore: cast_nullable_to_non_nullable
as List<CartItemEntity>,selectedIds: null == selectedIds ? _self._selectedIds : selectedIds // ignore: cast_nullable_to_non_nullable
as Set<int>,
  ));
}
