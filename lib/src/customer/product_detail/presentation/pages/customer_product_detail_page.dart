          ...
          children: [
            Expanded(
              child: AppButton(
                ...
                onPressed: _isAddingToCart ? null : () => _onAddToCart(product),
              ),
            ),
            ...
            Expanded(
              child: AppButton(
                label: 'Beli Sekarang',
                isLoading: _isAddingToCart,
                onPressed: _isAddingToCart ? null : () => _onBuyNow(product),
              ),
            ),
          ],
        ),
  ...
  Future<void> _onAddToCart(ProductEntity product) async {
    ...
    try {
      ...
      result.fold(
        ...
        (_) =>
            AppSnackbar.success(context, 'Berhasil ditambahkan ke keranjang'),
      );
    } finally {
