...
mixin _$AddressModel {
 ...
 int get id;@JsonKey(name: 'recipient_name') String get recipientName; String get phone; String get address;@JsonKey(name: 'is_default') bool get isDefault;
...
@override
String toString() {
  return 'AddressModel(id: $id, recipientName: $recipientName, phone: $phone, address: $address, isDefault: $isDefault)';
}
...
@useResult
$Res call({
 int id,@JsonKey(name: 'recipient_name') String recipientName, String phone, String address,@JsonKey(name: 'is_default') bool isDefault
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'recipient_name')  String recipientName,  String phone,  String address, @JsonKey(name: 'is_default')  bool isDefault)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AddressModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'recipient_name')  String recipientName,  String phone,  String address, @JsonKey(name: 'is_default')  bool isDefault)  $default,) {final _that = this;
switch (_that) {
case _AddressModel():
return $default(_that.id,_that.recipientName,_that.phone,_that.address,_that.isDefault);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id, @JsonKey(name: 'recipient_name')  String recipientName,  String phone,  String address, @JsonKey(name: 'is_default')  bool isDefault)?  $default,) {final _that = this;
switch (_that) {
case _AddressModel() when $default != null:
return $default(_that.id,_that.recipientName,_that.phone,_that.address,_that.isDefault);case _:
  return null;
...
class _AddressModel implements AddressModel {
  const _AddressModel({required this.id, @JsonKey(name: 'recipient_name') required this.recipientName, required this.phone, required this.address, @JsonKey(name: 'is_default') required this.isDefault});
